...
const translations = {
  ...
  en: {
    dir: 'ltr', logoText: 'Beit Berl Academic College', title: 'On the Edge of Intelligence', subtitle: 'Guest Lecture Series on Artificial Intelligence in Education', aboutBtn: 'About the Series', registerBtn: 'Register Now', contactBtn: 'Contact Us', mailYishay: 'Email Yishay Mor', whatsappYishay: 'WhatsApp Yishay Mor', talksTitle: 'The Lectures', readMore: 'Read More', close: 'Close', timeLabel: 'Tuesdays, 18:30-19:30', locationLabel: 'Zoom Meetings', aboutModalTitle: 'About the AI Applications Course',
  ...
  ar: {
    dir: 'rtl', logoText: 'الكلية الأكاديمية بيت بيرل', title: 'على حافة الذكاء', subtitle: 'سلسلة محاضرات للضيوف حول الذكاء الاصطناعي في التعليم', aboutBtn: 'حول السلسلة', registerBtn: 'سجل الآن', contactBtn: 'اتصل بنا', mailYishay: 'أرسل بريدًا إلى يشاي مور', whatsappYishay: 'واتساب يشاي مور', talksTitle: 'المحاضرات', readMore: 'اقرأ المزيد', close: 'إغلاق', timeLabel: 'أيام الثلاثاء، 18:30-19:30', locationLabel: 'لقاءات زووم (Zoom)', aboutModalTitle: 'حول دورة تطبيقات الذكاء الاصطناعي',
...
function openModal(typeOrId) {
  ...
  if (typeOrId === 'about') {
    ...
    if (Array.isArray(abstractData)) {
      abstractHTML = "<ul class='list-disc list-inside space-y-1'>";
      abstractData.forEach(item => {
        abstractHTML += `<li>${item}</li>`;
      });
      abstractHTML += "</ul>";
    } else {
