...
const translations = {
  he: {
    dir: 'rtl', logoText: 'המכללה האקדמית בית ברל', title: 'על קצה הבינה', subtitle: 'סדרת הרצאות אורח על בינה מלאכותית בחינוך', aboutBtn: 'אודות הסדרה', registerBtn: 'הרשמה להרצאות', contactBtn: 'צור קשר', mailYishay: 'שלח דוא"ל לישי מור', whatsappYishay: 'וואטסאפ לישי מור', talksTitle: 'הרצאות האורח שלנו', readMore: 'קרא עוד', close: 'סגור', timeLabel: 'ימי שלישי בשעה 18:30-19:30', locationLabel: 'מפגשי זום (Zoom)', aboutModalTitle: 'אודות קורס פיתוח ושימוש ביישומי בינה מלאכותית',
